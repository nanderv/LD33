...
sentences[3] = [[words.examine],[words.the, null], [item,obj]  ]
sentences[4] = [[words.master]]
sentences[5] = [[words.eat],[obj]]
sentences[6] = [[words.attack],[np]]
sentences[7] = [[words.stand],[words.up, null]]
sentences[8] = [[words.pick],[words.up, null],[item, obj]]
...
definitions[15] =  {a:15,cmd: actions.unlock, 0: word_type.verb, 1: word_type.subject}
